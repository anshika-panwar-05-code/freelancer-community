      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-gray-400 hover:text-gray-500">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C4.878 5 11.132 5 12 5s7.142 0 7.812.418Zm-9.812 7.57V9.012l6.667 3.008-6.667 3.008Z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
          ...
          <div className="mt-16 xl:col-span-2 xl:mt-0">
            <div className="grid grid-cols-2 gap-y-10 sm:grid-cols-3 sm:gap-x-12">
              <div className="space-y-4">
                <h3 className="text-sm font-semibold leading-6 text-white">Solutions</h3>
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Health</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Architecture</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Safety</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Support</a>
                  </li>
                </ul>
              </div>
              <div className="space-y-4">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Company</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Leadership</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Careers</a>
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Design</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Development</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Marketing</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm leading-6 text-white hover:text-gray-900">Advertising</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mt-16 border-t border-gray-200 pt-8">
          <p className="text-sm leading-6 text-white">© 2024 All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
